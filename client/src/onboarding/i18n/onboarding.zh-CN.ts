...
export default {
  onboarding: {
    ...
    mobile: {
      ...
      flow: {
        homeTitle: '首页：一句话，发给导演',
        homeDesc: '中央输入框写下目标后回车，内容直接发给导演并弹出对话；最近项目与灵感、引导默认折叠，点条展开。',
        museTitle: '第二步：点燃灵感',
        museDesc: '从一个梦境、一句歌词、一个瞬间感觉开始——AI 灵感种子帮你扩展创意。',
        worldTitle: '第三步：构建世界',
        worldDesc: '创建角色、地点、物品——世界观是故事的根基。AI 设定专家协助你。',
        synopsisTitle: '第四步：故事梗概',
        synopsisDesc: '从一句话到完整梗概和节奏表——节奏决定张力。',
        structureTitle: '第五步：大纲编排',
        structureDesc: '规划章节结构与情节走向。大纲是导航图。',
        productionTitle: '第六步：剧本创作',
        productionDesc: '场景级撰写，支持互动剧本与小说双模式。AI 编剧为你执笔。',
        blueprintTitle: '第七步：故事蓝图',
